...
Generated: 2026-09-25T17:30:17.712Z
...
| 1. Khách đặt lịch công khai (Acrylic Full Set + Ava Robertson, hôm nay) | PASS | appointment_id=106, service_id=193, staff_id=NV0053 |
...
| 3. Xác nhận thanh toán (Tip mặt $10 + Tip thẻ $5) | PASS | HTTP 200, order_id=896, total=110 |
...
| 4c. Phiếu lương 3 dòng khớp từng xu (Cash Payout / Check-Deposit / Tax Withheld) | PASS | Panel hiện: cash=$45.00, check=$511.57, tax=-$90.28, net=$556.57 — kỳ vọng: cash=$45, check=$511.57, tax=$90.28, net=$556.57 (thuế ước tính 15%, không phải engine thuế thật) |
